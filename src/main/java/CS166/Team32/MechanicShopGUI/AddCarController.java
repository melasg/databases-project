...
public class AddCarController {
    ...
    public void handleAddAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            List<List<String>> data = conn.executeQueryAndReturnResult("SELECT MAX(ownership_id) FROM owns");
            ...
            Platform.runLater(() -> {
                try {
                    ...
                    results.SetLabel("Car " + txtAddCarMake.getText() + " " + txtAddCarModel.getText() + " VIN " + txtAddCarVIN.getText() + " added successfully for customer ID " + txtCustomerID.getText() + "!");
