...
public class AddCustomerController implements Initializable {
  public TextField txtAddCustomerFName;
    ...
    public void handleCreateAction() {
        ...
        try {
            ConnectionController connectionClass = new ConnectionController();
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("fxml/ResScreen.fxml"));
